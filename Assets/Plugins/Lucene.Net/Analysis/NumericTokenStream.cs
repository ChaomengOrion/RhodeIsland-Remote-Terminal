...
namespace Lucene.Net.Analysis
{
    ...
    public sealed class NumericTokenStream : TokenStream
    {
        ...
        private sealed class NumericAttributeFactory : AttributeSource.AttributeFactory
        {
            ...
            public override Net.Util.Attribute CreateAttributeInstance<T>()
            {
        ...
        /// @since 4.0
        /// </summary>
        public sealed class NumericTermAttribute : Net.Util.Attribute, INumericTermAttribute, ITermToBytesRefAttribute
        {
