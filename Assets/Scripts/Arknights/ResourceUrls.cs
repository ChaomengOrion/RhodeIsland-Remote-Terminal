...
namespace RhodeIsland.Arknights
{
	public static class ResourceUrls
	{
		...
		/*private static string _GetChrIllustResPath(CharQuery charQuery, string illustId)
		{
			return null;
		}*/
		...
		public static string IllustLoaderOnlyChrIllustResPath(CharQuery charQuery, string prefabName)
		{
			return null;
		}*/
		...
		{
			return STORY_REVIEW_ACTIVITY_IMG_HUB_PATH;
		}
		public static string GetStoryReviewMiniActivityImageHubPath()
		{
			return STORY_REVIEW_MINI_ACTIVITY_IMG_HUB_PATH;
		}
		public static string GetStoryReviewMiniStoryDetailImageHubPath()
		{
			return STORY_REVIEW_MINI_STORY_DETAIL_IMG_HUB_PATH;
		}
		public static string GetStoryReviewMiniStoryCharImageHubPath()
		{
			return STORY_REVIEW_MINI_STORY_CHAR_IMG_HUB_PATH;
		}
		...
		private const string RETRO_SQUAD_HOME_PLUGIN_PREFAB = "UI/Retro/SquadHomePlugin/retro_{0}";
		...
		private const string ROGUELIKE_ARCHIVE_CHAT_PATH = "UI/Roguelike/Chat/archive_chat";
